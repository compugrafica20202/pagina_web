        ...
        <>
            <Grid item container justify="center" spacing={2}>
                <Grid item xs={12} sm={6} md={3}>
                    <Field 
                        name="cantidad_lineas" type="text" as={TextField} variant="outlined"
                        label="Líneas"
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Field 
                        name="cantidad_jaulas_por_linea" type="text" as={TextField} variant="outlined"
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Field 
                        name="cantidad_aves" type="text" as={TextField} variant="outlined"
                ...
                <Grid item xs={12} sm={6} md={3}>
                    <Field 
                        name="cantidad_niveles" type="text" as={TextField} variant="outlined"
                        label="Niveles"
            ...
            <Grid item container justify="center">
                    <FormControlLabel
                        control={<Field name="lineas_enfrentadas" type="checkbox" as={Checkbox} color="primary"/>}
